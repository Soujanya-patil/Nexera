    ...
    <div>
      ...
      <section className="bg-paper">
        <div className="mx-auto max-w-3xl px-6 py-16">
          <h2 className="font-serif text-2xl font-semibold text-ink">Our Story</h2>
          <p className="mt-4 text-graphite leading-relaxed">
            ...
            by service that actually shows up. We're an authorized TCL and Hithium
      ...
      <section className="bg-ice border-y border-line">
        <div className="mx-auto max-w-6xl px-6 py-16">
          <h2 className="font-serif text-2xl font-semibold text-ink">Leadership Team</h2>
      ...
      <section className="bg-paper">
        <div className="mx-auto max-w-3xl px-6 py-16">
          <h2 className="font-serif text-2xl font-semibold text-ink">Why Nexera</h2>
